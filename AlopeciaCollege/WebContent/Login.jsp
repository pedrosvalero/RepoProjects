...
<head>
	...
	<!-- Font Lara (Por si os gusta más, y añadir F en la font de css, y borrar la otra) <link href="https://fonts.googleapis.com/css2?family=Russo+One&display=swap" rel="stylesheet"> -->
...
<body>
	...
	<form action = "https://hjava.herokuapp.com/registro.jsp" method = "POST" accept-charset="ISO-8859-1">
		<caption><center><h4>Inicio de sesión</h4></caption>
	    ...
	    <div class="container-all">
	      <div class = "container-body">
	        <div class="colum1">
	          ...
	          <a href="#">Términos y Privacidad</a><br>
	          <a href="#">Cookies</a><br>
	        ...
	        <div class="colum3">
	          ...
	          <div class="row2">
	            <i class="fas fa-home"></i> <label>País de Nunca Jamás</label></i>
	          </div>
	          <div class="row2">
