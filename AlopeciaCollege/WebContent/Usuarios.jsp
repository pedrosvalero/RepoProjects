  ...
  <table id="dtBasicExample" cellspacing="0" style="width: 90%; margin: auto; margin-top: 10px; margin-bottom: 100px;">
	...
	%>
       <tr style="background: lightgrey; opacity: 0.9;">
        ...
        <td>
	    	<center><a href="Controlador?opcion=e&dni=<%=rs.getString("dni") %>"><img data-tarjet="#modalEdit1" class="hoverable" id="editar" style ="width: 25px; border-radius: 100%;" src="img/edit.png"></a>
			 <a href="Controlador?opcion=b&dni=<%= rs.getString("dni") %>"><img class="hoverable" id="borrar" src="img/delete.png" style ="margin-left: 15px; width: 25px; border-radius: 100%;"></a></center>
		</td>
      </tr>
    <%
		}
