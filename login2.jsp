...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/estilos_login2.css">
	<!-- Font Awesome -->
	...
	<form action = "Login" method = "POST" accept-charset="ISO-8859-1">
		...
		<div class="modal-body mx-5">
			<div class="md-form mb-5">
	          <i id="icono" class="fas fa-envelope prefix"></i>
	          <input class="form-control validate" type="email" id="inputEmail" name="email_control" title="Email/Correo electrónico" required autofocus>
	          <label id="text" data-error="wrong" data-success="right" for="inputOfficeInput1">Correo electrónico</label>
	          <span style="color: red"><%=(request.getAttribute("msgerr") == null) ? "" : request.getAttribute("msgerr") %></span>
	        </div>
	        <div class="md-form mb-5">
	          <i id="icono" class="fas fa-key prefix" ></i>
	          <input class="input" type="password" name="pass_control" minlength="6" title="Contraseña de la cuenta" required >
