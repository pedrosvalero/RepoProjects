        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div id ="resultado" class="form-check"></div>
                	<button id="btnAvanzar" onClick = "siguiente()" class="btn btn-primary mt-4">Siguiente pregunta</button>
           		 </div>
        </div>
    </div>
    </div>
...
var puntuaciones = [
	...
	function checkOn(){
		...
		console.log(respuesta_puntuacion[contestacion -1]);
