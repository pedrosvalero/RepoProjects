...
<div class="row">
    <div class="col active-with-click" id="block" >
        <div id="rol" class="col-md-9 col-sm-6 col-xs-12">
	...
	<div class="col active-with-click"id="block">
	    ...
	    <div class="modal-body mx-5">
	        ...
	        <div class="md-form mb-5">
	          ...
	          <select id ="localidad" class="custom-select custom-select-sm" >
	        ...
	        <div id="boton"class="text-center">
			  <button class="btn btn-default btn-rounded mb-3" data-toggle="modal" data-target="#modalContactForm" style="border-radius: 20px;" type="submit">Editar</button>
